    ...
    public Layer(int inNeurons,int numberNeurons) {
        ...
        for(int i = 0; i < numberNeurons; i++) {
            ...
            for(int j = 0; j < inNeurons; j++) {
                weights[j] = MathematicalExpressions.RandomFloat(Neuron.minWeightValue, Neuron.maxWeightValue);
            }
            neurons[i] = new Neuron(weights,MathematicalExpressions.RandomFloat(0, 1));
        }
    }
